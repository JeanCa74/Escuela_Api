...
// Auth construye un middleware que exige un JWT válido en Authorization: Bearer <token>.
// Delega la validación al AuthService: el middleware NO sabe de firmas ni de claims.
